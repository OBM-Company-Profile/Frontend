...
- To test the code, type "npm run dev" then Ctrl + click the url
  ...
  **Make sure you've install Node JS (current version preferred) and Typescript before running the project. Also you need axios for data fetching from backend**
